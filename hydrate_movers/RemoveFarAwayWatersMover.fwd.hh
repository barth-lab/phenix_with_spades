...
typedef utility::pointer::shared_ptr< RemoveFarAwayWatersMover > RemoveFarAwayWatersMoverOP;
typedef utility::pointer::shared_ptr< RemoveFarAwayWatersMover const > RemoveFarAwayWatersMoverCOP;

} // namespace hydrate
} // namespace protocols

#endif  // INCLUDED_protocols_hydrate_RemoveFarAwayWatersMover_FWD_HH
